...
<main>
          ...
          <p>
              ...
              <div class="input-group">
                <label for="link">
                 <img srcset="link.svg" alt="Link Icon">
                </label>
...
const updateImageLinks = () => {
  document.querySelectorAll("img").forEach((img) => {
    if(img.srcset.includes('githubusercontent')){
      return  
    }
    const srcset = img.getAttribute('srcset')
    img.srcset = `https://raw.githubusercontent.com/maykbrito/my-public-files/main/nlw-19/${img.srcset}`
  })
}
                ...
                <section class="registration">
                    ...
                    <form id="form">
                        <div class="input-wrapper">
                            <div class="input-group">
                                <label for="email">
                                    <img srcset="mail.svg" alt="Email icon">
                                </label>
                                <input type="email" name="email" id="email" placeholder="E-mail">
                            </div>
                            <div class="input-group">
                                <label for="phone">
                                    <img srcset="phone.svg" alt="Phone icon">
                                </label>
                        ...
                        <button>
                            Confirmar
                            <img srcset="arrow.svg" alt="Arrow right">
                        </button>
                    </form>
